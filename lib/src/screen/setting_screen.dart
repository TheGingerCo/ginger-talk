...
import 'package:talk/config.dart';
import 'package:talk/constants.dart';
import 'package:talk/src/button_widget.dart';
...
import 'package:talk/src/widgets/edit_and_send_invitation_btn.dart';
import 'package:talk/src/widgets/user_info_card.dart';
      ...
      child: Container(
        child: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Text(AppContent.myPersonalMeetingID,
