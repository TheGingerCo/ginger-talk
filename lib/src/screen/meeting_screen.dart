...
import 'package:talk/src/services/get_config_service.dart';
import 'package:talk/src/strings.dart';
import 'package:talk/src/style/theme.dart';
import 'package:talk/src/widgets/admob_widget.dart';
import 'package:talk/src/widgets/host_meeting_card.dart';
import 'package:talk/src/widgets/join_meeting_card.dart';
...
class _MeetingScreenState extends State<MeetingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    appMode = configService.appConfig() != null
        ? configService.appConfig().appMode
        : "free";
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            _authUser != null
                ? appMode == "academic" && _authUser.role == "subscriber"
