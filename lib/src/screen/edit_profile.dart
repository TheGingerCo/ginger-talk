...
class EditProfileScreen extends StatefulWidget {
  ...
  const EditProfileScreen(
      {Key key, @required this.authUser, @required this.profileUpdatedCallback})
      : super(key: key);
  @override
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    editProfileNameController =
        new TextEditingController(text: widget.authUser.name);
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  AppContent.ifYouWontUseYourAccount,
                  style: CustomTheme.displayTextOne,
                ),
                SizedBox(height: 20.0),
                HelpMe().accountDeactivate(
                    screnWidth, AppContent.deactivateAccount),
              ],
            ),
          ),
          decoration: new BoxDecoration(
  ...
  accountDeactivate(context) async {
    ...
    if (_accountDeactivate != null) {
      if (_authService.getUser() != null) _authService.deleteUser();
      Navigator.of(context).pop();
      Navigator.push(
        context,
