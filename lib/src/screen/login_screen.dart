...
import 'package:talk/src/bloc/auth/login_bloc.dart';
import 'package:talk/src/bloc/auth/login_event.dart';
import 'package:talk/src/bloc/auth/login_state.dart';
import 'package:talk/src/bloc/firebase_auth/firebase_auth_bloc.dart';
import 'package:talk/src/bloc/firebase_auth/firebase_auth_event.dart';
import 'package:talk/src/bloc/firebase_auth/firebase_auth_state.dart';
...
import 'package:talk/src/services/authentication_service.dart';
import 'package:talk/src/style/theme.dart';
import 'package:talk/src/utils/edit_text_utils.dart';
import 'package:talk/src/utils/loadingIndicator.dart';
import 'package:talk/src/utils/validators.dart';
import 'package:talk/src/widgets/google_fb_phone_btn.dart';
import 'package:talk/src/widgets/signup_submit_btn.dart';
    ...
    return Container(
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              AppContent.preceedResetPassword,
            ...
            return AlertDialog(
              ...
              actions: <Widget>[
                GestureDetector(
                    ...
                    child: HelpMe()
                        .submitButton(60, AppContent.okText, height: 30.0)),
              ],
            );
          });
    } else {
