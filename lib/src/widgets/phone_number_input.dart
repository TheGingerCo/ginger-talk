...
import 'package:talk/src/bloc/phone_auth/phone_auth_event.dart';
                ...
                onTap: () {
                  if (_formKey.currentState.validate()) {
                    ...
                    BlocProvider.of<PhoneAuthBloc>(context).add(SendOtpEvent(
                        phoNo: _selectedCountryCode +
                            _phoneTextController.value.text));
                  }
                },
                child:
                    HelpMe().submitButton(screnWidth, AppContent.continueText)),
          ),
          Text(
