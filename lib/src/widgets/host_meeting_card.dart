...
class _HostMettingCardState extends State<HostMeetingCard> {
  ...
  void initState() {
    ...
    _initPackageInfo();
    meetingPrefix = Hive.box<GetConfigModel>('getConfigbox')
        .getAt(0)
        .appConfig
        .meetingPrefix;
    ...
    interstitialAd = AdmobInterstitial(
      adUnitId: Hive.box<GetConfigModel>('getConfigbox')
          .getAt(0)
          .adsConfig
          .admobInterstitialAdsId,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                      ...
                      child: HelpMe()
                          .submitButton(screnWidth, AppContent.createJoinNow))
                ],
              ),
            ),
            decoration: new BoxDecoration(
