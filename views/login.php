...
<head>
  ...
  <meta name="description" content="Create and join unlimited and free meetings in Ginger Talk! Connect with your friends and family even during pandemic peaks without any hiccups! Powered by - The Ginger Co.">
  <meta name="author" content="Maanas Nair">
  <link rel="shortcut icon" href="<?php echo base_url('uploads/system_logo/'.get_app_config("favicon")); ?>">

  <!-- open-graph -->
  <meta property="og:locale" content="en_US" />
  <meta name="twitter:card" content="summary">
  <meta name="twitter:description" content="Join and create a free meeting at <?php echo $app_name; ?> by - The Ginger Co." />
  <meta name="twitter:title" content="<?php echo $app_name; ?> by - The Ginger Co." />
  <meta name="twitter:image" content="<?php echo $og_image; ?>">
  <meta name="twitter:site" content="@<?php echo $app_name; ?>">

  <meta property="og:title" content="<?php echo $app_name; ?> by - The Ginger Co." />
  <meta property="og:url" content="<?php echo base_url(); ?>" />
  <meta property="og:type" content="website" />
  <meta property="og:description" content="Join and create a free meeting at <?php echo $app_name; ?> by - The Ginger Co." />
  <meta property="og:image" content="<?php echo $og_image; ?>" />
  <meta property="og:image:alt" content="<?php echo $app_name; ?> - Logo/Favicon">

  <title><?php echo get_app_config("app_name") ?> - Login | The Ginger Co.</title>
